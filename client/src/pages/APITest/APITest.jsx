...
import { getUsers, createUser, updateUser, deleteUser } from '../../services/userServices.js';
...
export const APITest = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setForm({ nome: '', email: '', senha: '', tipo_usuario: 'cliente' });
            fetchUsers();
        } catch (err) {
    ...
    const handleEdit = (user) => {
        setForm({ nome: user.nome, email: user.email, senha: '', tipo_usuario: user.tipo_usuario });
            ...
            <ul>
                {filteredUsers.map(user => (
                    <li key={user.id_usuario}>
                        ...
                        <button onClick={() => handleDelete(user.id_usuario)}>Deletar</button>
                    </li>
                ))}
            </ul>
        </div>
